...
from APIStockServer.initialize import initialize_api_objects, initialize_email_sender, initialize_sprott_etf_calculators
...
if __name__ == "__main__":
    ...
    # Read email addresses for email_sender from config file
    ...
    metal_etf_alerts = MetalEtfAlerts(email_sender, sprott_etfs_calculators, receivers_emails)
